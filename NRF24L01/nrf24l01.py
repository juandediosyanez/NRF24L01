...
"""
Este archivo nrf24l01.py es una versión ligeramente modificada de "lib_nrf24.py" de 
Brian Lavery Oct 2014, que a su vez parte de "pynrf24" de Joao Paulo Barraca.

La finalidad de este ajuste es hacer accesible de forma práctica en un único repositorio 
el uso de un módulo de radio NRF24L01 por parte de una Raspberry PI con Python y spidev.

Juan de Dios Yáñez Diciembre 2018
www.juandediosyanez.es

LICENCIA:

    GNU General Public License v2.0 -> https://www.gnu.org/licenses/old-licenses/gpl-2.0.html
    - Sin responsabilidad ni garantias.
"""
